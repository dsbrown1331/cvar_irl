...
#code for running an okay experiment. Seems like beating worst-case is hard in a worst-case setting. 
#maybe we can show that we get a full spectrum of behaviors. Maybe show that sometimes worst-case is too pessimistic. 
