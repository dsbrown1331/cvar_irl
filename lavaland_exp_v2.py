...
#try less grass and use mdps with only four corner inits
...
experiment_name = 'grid5x5_ploss_lavaocc_v2_lessgrass_fewer_inits_alpha99.txt'
import os
...
for t in range(num_trials):
    ...
    #train mdp
    mdp_env_A = mdp_worlds.lavaland_small_lessgrass(contains_lava=False)
    #test mdp ((probably) has lava)
    mdp_env_B = mdp_worlds.lavaland_small_lessgrass(contains_lava=True)
